---
layout  : wiki
title   : JVM과 Java 코드 실행원리
summary : 
date    : 2023-02-18 23:35:34 +0900
updated : 2023-03-26 10:03:49 +0900
tag     : java jvm
...
[^1]: A Java virtual machine (JVM) is a virtual machine that enables a computer to run Java programs as well as programs written in other languages that are also compiled to Java bytecode. (wiki) 
